...
# server.crt: Server certificate si!gned by the CA (this would be sent back by the CA owner) - keep on server
# Summary 
...
# "/C=US/ST=WA/L=Seattle/O=Test/OU=Test/CN=ca"
# C: country
# ST: state
# L: location of city
# O: Organisation name
# OU: Server or Client.  OU must be Server for server and Client for client
# CN : commaon : anything you want: localhost etc
